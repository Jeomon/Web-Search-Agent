...
async def main():
    async with async_playwright() as p:
        ...
        # Fetch the accessibility snapshot
        a11y_snapshot = await page.accessibility.snapshot()

        # Build the A11y tree and get coordinates
        tree_string, coordinates = await build_a11y_tree(a11y_snapshot, page)

        # Print the A11y tree and coordinates
