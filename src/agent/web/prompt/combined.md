...
NOTE: Make actions based on the **ally tree only**.
...
5. **Playwright Compatibility**: All inputs to tools should be compatible with `Playwright` to ensure seamless execution. 
